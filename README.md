...
uv add "recall-guard[backtest] @ git+https://github.com/norandom/memguard_alpha.git@v0.4.1"
```
...
```bash
uv venv
uv pip install https://github.com/norandom/memguard_alpha/releases/download/v0.4.1/recall_guard-0.4.1-py3-none-any.whl
```
