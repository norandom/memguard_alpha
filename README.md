...
uv add "recall-guard[backtest] @ git+https://github.com/norandom/memguard_alpha.git@v0.3.0"
```
...
```bash
uv venv
uv pip install https://github.com/norandom/memguard_alpha/releases/download/v0.3.0/recall_guard-0.3.0-py3-none-any.whl
```
