...
:func:`src.mia.mcs.train`; ``train_mcs`` is re-exported as an alias here so
...
from src.mia.control import ControlBaseline, build_baseline, standardise
from src.mia.features import LOGPROB_FLOOR, MiaFeatures, compute_mia_features
from src.mia.mcs import MCSCalibrator
from src.mia.mcs import train as train_mcs
